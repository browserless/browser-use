...
script_generation_dir = os.path.join(
	os.path.dirname(os.path.dirname(os.path.abspath(__file__))), 'browser_use', 'script_generation'
)
...
class TestScriptGenerator(unittest.TestCase):
	...
	def setUp(self):
		...
		self.action_log = [
			{'action_type': 'go_to_url', 'params': {'url': 'https://example.com'}, 'selector': None, 'timestamp': 1620000000.0},
			{
